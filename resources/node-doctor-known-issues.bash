...
check_known_issues() {
    ...
    add_result "known_issues" "gno_pr_6054" "WARN" \
        "Managed Sapphire release predates upstream P2P dial-loop fix #6054" \
        ...
        "Do not blind-upgrade a validator. Review the next official Sapphire release or a validated backport before changing the running binary."
}
