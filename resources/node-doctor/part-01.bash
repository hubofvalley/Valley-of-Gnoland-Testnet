...
load_managed_profile_exports() {
    ...
    for managed_name in GNO_SOURCE_DIR GNOLAND_TESTNET_HOME GNOLAND_GENESIS GNOKEY_HOME GNOROOT \
        GNOLAND_BIN GNOKEY_BIN GNOLAND_TESTNET_SERVICE_NAME GNOLAND_PORT GNOLAND_REMOTE GNOLAND_PUBLIC_REMOTE; do
    ...
    while IFS= read -r line || [ -n "$line" ]; do
        ...
        case "$name" in
            GNO_SOURCE_DIR|GNOLAND_TESTNET_HOME|GNOLAND_GENESIS|GNOKEY_HOME|GNOROOT|GNOLAND_BIN|GNOKEY_BIN|GNOLAND_TESTNET_SERVICE_NAME|GNOLAND_PORT|GNOLAND_REMOTE|GNOLAND_PUBLIC_REMOTE|PATH)
                ;;
            *)
                continue
                ;;
